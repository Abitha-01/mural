...
var map = L.map('map') 
    .setView([10.8505, 76.2711], 7);  // Coordinates of Kerala with zoom level 7
 
    const accessToken = "your.mapbox.access.token";

    // Use Mapbox's 'light' or 'dark' theme style (for black and white)
...
window.addEventListener('scroll', function () {
    ...
    // Trigger when the "Swipe Up" text enters the viewport (about 75% of screen)
